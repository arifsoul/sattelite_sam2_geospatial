    ...
    with rasterio.open(source) as src:
        ...
        if dst_crs is not None:
            try:
                ...
                print("Error: GeoDataFrame tidak memiliki CRS yang ditetapkan. Tetapkan CRS awal terlebih dahulu sebelum konversi.")
            except pyproj_exceptions.CRSError as ce:
                print("Error: CRS tujuan tidak valid atau tidak ditemukan. Periksa kembali kode CRS tujuan.")
            except Exception as e:
